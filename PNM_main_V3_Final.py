...
Two flow fields can be simulated with this code including:
    1. The flow-through flow field (FTFF): The FTFF flow field is modelled using boundary condition, and depletion over 
    ...
    2. The interdigitated flow field (IDFF): The IDFF flow field is modelled using boundary conditions. Depletion over the
...
v_in_vec = [10e-2]                             # Inlet velocities [m/s]  
j0_vec = [1000]                                  # Current densities [A/m2]  
