...
class Transport(Algorithm):
    ...
    def run(self, solver=None, x0=None, verbose=False):
        ...
        Gamma_fit = net['pore.Fitting_parameter_Gamma'][0] # Flow pattern constant (1 = flat velocity profile, 2 = Parabolic velocity profile)
    ...
    def _run_special(self, solver, x0, w=0.5, verbose=None):
        ...
        # Update SteadyStateSolution object on algorithm (placed from bottom to here: update pressure field to recompute hydraulic conductance)
